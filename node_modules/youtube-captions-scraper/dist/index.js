...
let getSubtitles = (exports.getSubtitles = (() => {
  var _ref = _asyncToGenerator(function*({ videoID, lang = 'en' }) {
    var _ref2 = yield _axios2.default.get(
    ...
    if (!decodedData.includes('captionTracks')) {
      ...
      // //original code
      throw new Error(
        `Could not find captions for video: ${videoID}`,
      );
    }
